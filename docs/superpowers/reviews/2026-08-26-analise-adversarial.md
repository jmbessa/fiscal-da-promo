...
- **A7. Nenhum post identifica que é publicidade / link de afiliado** — CDC art. 36, guia CONAR para influenciadores (2021), política de conteúdo de marca da Meta. Um canal que se chama "Fiscal" e omite a comissão em cada post é o perfil que gera representação no CONAR. Linha fixa em todo post: "🔗 link de afiliado · #publi" (decisão de texto do dono).
  - **REESCRITO em 2026-08-30 — o pior caso não é multa, é o fim da monetização.** O registro original tratava A7 como risco REGULATÓRIO, e quem o lesse concluiria que o pior desfecho é uma representação no CONAR. É maior que isso, por duas fontes que não estavam aqui:
    - **contratual.** Os Termos do Programa de Afiliados da Shopee, cláusula **2.3**, alcançam conteúdo que a Shopee considere inadequado; a **7.2** permite a ela "rescindir unilateralmente este Contrato a seu exclusivo critério", com 7 dias de aviso. Perder o programa não custa dinheiro: custa a comissão, a integração, o pool de links e o histórico. Fonte primária: <https://help.shopee.com.br/portal/10/article/124094-Programa-de-Afiliados-Shopee-Termos-e-Condi%C3%A7%C3%B5es>
    - **o guia CONAR de 01/06/2026** (posterior a esta análise) inclui afiliados com todas as letras — "remuneração por performance não afasta a natureza publicitária" — e exige identificação **visível na primeira visualização**, não em nota de rodapé.
  - **Custo de mitigar:** uma linha na frase-assinatura que o sistema já acrescenta em toda peça. **Custo de alcance: zero** — o Instagram rebaixa isca de engajamento, não divulgação de publicidade, e mantém ferramenta própria para ela.
  - **Estado ao fim de 2026-08-30: NÃO MITIGADO, por decisão do dono.** A sinalização chegou a ser implementada e testada na fase 5U ("Link de afiliado — ganho comissão, o preço é o mesmo para você", primeira linha das quatro legendas, mais um chip na arte) e foi **retirada no mesmo dia**, com o motivo dele: *"não gostei e afasta a possibilidade de compra por parte do usuário"*, somado à observação de que perfis com milhões de seguidores não sinalizam.
  - O que ficou no lugar — `creative.AFILIADO`, que dizia "O link direciona para a página do produto na loja" — **nunca foi sinalização**: descrevia o destino do link, não identificava o post como publicidade e não revelava a comissão. **Em 2026-09-08 o dono retirou também essa linha**, e hoje `creative.AFILIADO = ""` (vazia = desligada, no molde de `AFILIADO_NA_ARTE`): nenhuma legenda diz mais nada a respeito. Registre-se a diferença com precisão — tirá-la **não derrubou conformidade, porque não havia conformidade a derrubar**; o que mudou é que sumiu até a frase que podia ser lida por engano como tal. O chip da arte segue desligado (`AFILIADO_NA_ARTE = ""`), porque o botão do rodapé já diz que o link leva à loja.
  - Uma palavra teve de mudar por um motivo interno, e vale registrar: a frase do dono dizia "página da promoção", e "promoção" dispara `copywriter.alega_desconto`. A linha entra na legenda de TODO post, inclusive os de modo B — que hoje são 100% deles —, então seria a peça chamando de promoção o que a própria régua se recusa a certificar. Virou "página do produto".
  - **O risco corrente é perda de monetização ACEITA CONSCIENTEMENTE**: a Shopee pode rescindir pela cláusula 7.2 a exclusivo critério dela, e com o programa vão a comissão, a integração, o pool de links e o histórico. O mecanismo da fase 5U continua inteiro no código, atrás de duas constantes — religar é editar duas linhas, não reimplementar.
