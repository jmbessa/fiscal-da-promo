...
- **A7. Nenhum post identifica que é publicidade / link de afiliado** — CDC art. 36, guia CONAR para influenciadores (2021), política de conteúdo de marca da Meta. Um canal que se chama "Fiscal" e omite a comissão em cada post é o perfil que gera representação no CONAR. Linha fixa em todo post: "🔗 link de afiliado · #publi" (decisão de texto do dono).
  ...
  - O que ficou no lugar — `creative.AFILIADO`, hoje "O link direciona para a página do produto na loja" — **não é sinalização**: descreve o destino do link, não identifica o post como publicidade e não revela a comissão. **Não leia a existência dessa linha como conformidade.** O chip da arte está desligado (`AFILIADO_NA_ARTE = ""`), porque o botão do rodapé já diz que o link leva à loja.
